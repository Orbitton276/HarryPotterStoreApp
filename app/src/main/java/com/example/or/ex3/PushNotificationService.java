...
import com.example.or.ex3.ProductsActivity;
...
public class PushNotificationService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        intent.putExtra("name",data.get("product_name"));
        intent.putExtra("category",data.get("category_name"));
        intent.putExtra("maxprice",data.get("product_max_price"));
